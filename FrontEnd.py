...
class FrontEnd():
	...
	def GenerateTKWindow(self):
		...
		self.checkButton_sr_log_end_on_profile_end.pack(side = "bottom", pady = (5, 0), expand = "false", fill = tk.X)
		...
		self.checkButton_sr_log_start_on_profile_start.pack(side = "bottom", pady = (5, 0), expand = "false", fill = tk.X)
		...
		self.checkButton_pr_log_end_on_profile_end.pack(side = "bottom", pady = (5, 0), expand = "false", fill = tk.X)
		...
		self.checkButton_pr_log_start_on_profile_start.pack(side = "bottom", pady = (5, 0), expand = "false", fill = tk.X)
